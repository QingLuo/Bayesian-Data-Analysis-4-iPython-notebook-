...
assignment down by Qing Luo, March 25th
"""
...
class UnivariateBayesianInference(object):
    ...
    def sample_rwm(self, n, w, param0):
        samplerwm=[0 for i in range(n)]
        samplerwm[0]=param0
        x = param0
        i = 1
        t=0
        y = random.uniform(x-w/2,x+w/2)
        while i < n:
        ...
        return   samplerwm, (1.00*t)/(1.00*n)
